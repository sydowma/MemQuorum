...
public class RaftNode {
    ...
    // 选举超时配置（毫秒）- 增加超时时间以适应容器环境
    private final int electionTimeoutMin = 2000;  // 2 seconds
    private final int electionTimeoutMax = 4000;  // 4 seconds
    private final int heartbeatInterval = 500;    // 500ms heartbeats
